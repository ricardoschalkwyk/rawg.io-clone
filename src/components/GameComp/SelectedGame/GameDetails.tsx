...
const GameDetails = () => {
  return (
    <div>
      ...
      <div className="mt-3">
        <div className="text-7xl font-bold">High on Life</div>
      </div>
      ...
      <div className="mt-10 flex flex-col justify-between">
        ...
        <div className="flex w-full rounded-md">
          <div className="w-full rounded-l-md bg-gradient-to-b from-rating-green-light to-rating-green-dark py-3 hover:shadow-[1px_1px_6px_1px_rgb(300,300,300,300)]">
            green
          </div>
          <div className="w-full bg-gradient-to-b from-rating-blue-light to-rating-blue-dark hover:shadow-[1px_1px_6px_1px_rgb(300,300,300,300)]">
            blue
          </div>
          <div className="w-full bg-gradient-to-b from-rating-orange-light to-rating-orange-dark hover:shadow-[1px_1px_6px_1px_rgb(300,300,300,300)]">
            orange
          </div>
          <div className="w-full rounded-r-md bg-gradient-to-b from-rating-red-light to-rating-red-dark hover:shadow-[1px_1px_5px_1px_rgb(300,300,300,300)]">
            red
          </div>
        </div>
