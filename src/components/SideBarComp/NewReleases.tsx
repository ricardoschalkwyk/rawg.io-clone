  ...
  return (
    <div className="space-y-1.5">
      <Button className="flex items-center gap-2 border-solid text-lg font-thin">
        <StarIcon className="h-7 w-7 rounded-md bg-brand-gray p-0.5" />
        <div>Last 30 days</div>
      </Button>

      <Button className="flex items-center gap-2 border-solid text-lg font-thin">
        <FireIcon className="h-7 w-7 rounded-md bg-brand-gray p-0.5" />
        <div>This week</div>
      </Button>

      <Button className="flex items-center gap-2 border-solid text-lg font-thin">
        <ForwardIcon className="h-7 w-7 rounded-md bg-brand-gray p-0.5" />
        <div>Next week</div>
      </Button>
